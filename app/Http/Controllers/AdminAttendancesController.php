<?php namespace App\Http\Controllers;
	...
	class AdminAttendancesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"Users Id","name"=>"users_id","join"=>"users,name"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Employee','name'=>'users_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'users,name'];
